...
export default function Courses() {
    ...
    return (
        <>
            ...
            {/* ══ PAGE HERO ══ */}
            <section className="page-hero"  data-aos="fade-right">
                <div className="wrap">
            ...
            <section className="it-section">
                <div className="wrap">
                    <div className="sec-label">
                        <div className="sec-label-icon" data-aos="fade-up">
                        ...
                        <div data-aos="fade-down">IT Courses</div>
                    </div>
                    <div className="it-grid" data-aos="fade-up">
            ...
            <section style={{ background: "#fff", paddingBottom: 0 }}>
                <div className="wrap">
                    <div className="lang-row">
                        {/* English */}
                        <div className="en-card" data-aos="fade-down">
                            <div className="sec-label">
                        ...
                        {/* German */}
                        <div className="de-card" data-aos="fade-down">
                            <div className="de-bg">
            ...
            {/* ══ ARITHMETIC + TABLE ══ */}
            <section style={{ background: "#fff", padding: "24px 0 0" }} data-aos="fade-down-right">
                <div className="wrap">
            ...
            {/* ══ PLACEMENT TEST ══ */}
            <section className="placement" data-aos="fade-down-right">
                <div className="wrap">
                ...
                <div className="site-footer__inner">
                    ...
                    <div className="site-footer__top">
                        ...
                        <div className="site-footer__brand">
                            <img src={logo} alt="YuksalishLC" className="site-footer__logo-img" />

                            <p className="site-footer__tagline">
                                Empowering the next generation with cutting-
                                edge IT skills and global languages.
                            </p>
                        </div>
                        ...
                        <div className="site-footer__nav">
                            <div className="site-footer__col">
                                <h4 className="site-footer__col-title">Programs</h4>
                                <ul className="site-footer__list">
                                    {["IT Courses", "English", "German"].map((item) => (
                                        <li key={item}>
                                            <a href="#" className="site-footer__link">{item}</a>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                            ...
                            <div className="site-footer__col">
                                <h4 className="site-footer__col-title">Social</h4>
                                <div className="site-footer__socials">
                                    {/* Facebook */}
                                    <a href="#" className="site-footer__soc-btn" aria-label="Facebook">
                                    ...
                                    {/* Instagram */}
                                    <a href="#" className="site-footer__soc-btn" aria-label="Instagram">
                                        <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="site-footer__bottom">
                        <p className="site-footer__copy">© 2024 YuksalishLC. All rights reserved.</p>
